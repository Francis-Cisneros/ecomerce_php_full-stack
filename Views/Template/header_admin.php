...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="<?= media();?>/images/log.svg">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard"> <img  class="logo-movil" src="<?= media(); ?>/images/blanco-logo.png" alt=""></a>
